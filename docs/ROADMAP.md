...
| 秒読みの予算に序盤の係数を加える | [plans/time-management-opening-coefficient.md](plans/time-management-opening-coefficient.md) | 起案 | |

...
棋力向上段階9の採用構成は2026年9月23日にmasterへ統合された。
SPSAの時間切れ事前確認は104ペアで異常0件となり、段階9の採用構成の既定値から1,500反復×8ペアの最初の調整セッションを2026年9月24日に完了した。
有効11,444ペア、手数上限による破棄556ペア、エンジン異常0件だった。
最終値を反映した候補コミット`2ec3a5e`の事前対局は32ペアで時間切れとエンジン異常が0件となり、[STC採否測定](measurements/spsa-stage9-20260923-stc.md)は2026年9月25日に`H1`で終了した。
[LTC採否測定](measurements/spsa-stage9-20260923-ltc.md)も2026年9月25日に`H1`で終了し、SPSA候補は採用条件を満たした。
係数を定める設計書への反映を残す。

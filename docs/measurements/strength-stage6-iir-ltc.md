...
長時間GSPRTは`H1`だが、docs/guides/sprt.md が採用の条件とする時間切れ0件を満たしていない。
時間切れは外部のメモリ圧迫による対称な停止であり、該当ペアを除いても`H1`であることから、2026年9月11日に利用者が規則からの逸脱を記録したうえで採用すると決定し、internal iterative reductionを採用した。

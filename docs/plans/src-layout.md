...
2026年8月10日に、探索部の実装着手を前にsrcディレクトリ構成の方針を確定し、本設計書を起案した。crate構成、coreの責務基準、対局進行3モジュールの移動、探索部・評価関数の配置、core内部の構造、rngモジュールの扱い、adjudicationの命名の7論点を順に決定した。移動作業は同日に完了した（「実施記録」の節）。
